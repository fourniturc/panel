    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#000000' }}>
      ...
      <footer className="px-6 py-4 border-t border-[#333333]" style={{ backgroundColor: '#000000' }}>
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider" style={{ color: '#ff3b30' }}>
            <IconShield />
            100% Confidentiel
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-start">
            ...
            <div className="flex-1 min-w-0 space-y-6">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full py-4 rounded-xl text-base font-black text-white uppercase tracking-widest transition-opacity hover:opacity-90 disabled:opacity-60"
                style={{ backgroundColor: '#ff3b30', boxShadow: '0 8px 30px rgba(255,59,48,0.35)' }}
              >
      ...
      {!embed && (
        <footer className="px-6 py-5 mt-4 border-t border-[#333333]" style={{ backgroundColor: '#000000' }}>
          <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-1.5 text-xs font-black uppercase tracking-widest" style={{ color: '#ff3b30' }}>
              <IconShield />
              100% Confidentiel
            </div>
          </div>
